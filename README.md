...
🔗 [Repository](https://github.com/kairav11/Master_thesis)
...
- Compared regression and ensemble models such as Random Forest, XGBoost, and CatBoost  
- Evaluated performance using MAE, RMSE, R², and tolerance-based accuracy metrics  
- Integrated spatio-temporal context such as traffic and weather  
- Found ensemble models to outperform deep learning approaches in sparse-data settings  
